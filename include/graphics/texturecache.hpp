...
namespace BlueBear {
  namespace Graphics {
    ...
    class TextureCache {
      ...
      std::shared_ptr< Texture > generateForAtlasBuilderEntry( AtlasBuilderEntry& entry, AtlasBuilderMappings& mappings );
      ...
      public:
        ...
        std::shared_ptr< Texture > getUsingAtlas( const std::string& atlasBasePath, AtlasBuilderMappings& mappings );
        void prune();
    };
